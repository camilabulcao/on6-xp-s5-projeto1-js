...
console.log(`Colocamos em ordem os números 11 e 7: ${ordenarPraGente}`)
...
console.log(`Capturei o pokemon ${name} que tem o tipo ${type} e tem altura ${height}`)
...
const pessoa3 = new Pessoa('Camila', 'Bulcão', 28)
